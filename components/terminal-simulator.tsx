...
const terminalLines: TerminalLine[] = [
  ...
  { text: "E se a tecnologia não tivesse limites?", delay: 2300, type: "output" },
  { text: "E se você pudesse dominar o digital?", delay: 2400, type: "output" },
  ...
  { text: "nave-mae@digital:~$ grep -r 'projetos' ./", delay: 5800, type: "command" },
  {
